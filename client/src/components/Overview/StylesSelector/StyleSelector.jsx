  ...
  return (
    <div>
      ...
      {props.styles.map(style => {
        return <SpecificStyle style={style} setChosenStyle={props.setChosenStyle} key={uuidv4()} styleClicked={props.styleClicked} toggleClick={props.toggleClick} setMainImg={props.setMainImg} />
      })}
      </div>
    </div>
  )
