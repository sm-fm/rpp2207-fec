...
const RelatedProduct = (props) => {
  ...
  return (
    ...
    <div className='product-card-container'>
      ...
      <svg className="add-outfit-btn" width="20px" height="20px" viewBox="0 0 32 32" onClick={() => {props.addToOutfit(props.product)}}>
          <path fill={isInYourOutfit() ? "yellow" : "White"} stroke="black" strokeWidth="2px" d="M20.388,10.918L32,12.118l-8.735,7.749L25.914,31.4l-9.893-6.088L6.127,31.4l2.695-11.533L0,12.118
